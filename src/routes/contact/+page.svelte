      ...
      <div class="grid lg:grid-cols-12 gap-16 lg:gap-24">
        <div class="lg:col-span-5 space-y-12">
          <div class="ct-info-item">
            <span class="text-[9px] font-mono text-white/40 tracking-[0.5em] uppercase block mb-4">Direct Link</span>
            <a href="mailto:{siteEmail}" class="group flex items-center gap-3 interactive">
              <span class="text-xl md:text-2xl font-serif font-bold text-white group-hover:text-primary transition-colors duration-300">{siteEmail}</span>
          ...
          <div class="ct-form-card spotlight-card relative p-8 md:p-12 rounded-3xl border border-white/5 bg-white/2 hover:border-primary/10 transition-all duration-500 overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10 flex items-center justify-between mb-10">
              <div class="flex items-center gap-3">
                ...
                <span class="text-[10px] font-mono uppercase tracking-[0.4em] text-white/50">Send a Message</span>
              </div>
              <span class="text-[9px] font-mono text-white/30 tracking-wider uppercase hidden sm:block">Secure Form</span>
            </div>
            ...
            {#if isSuccess}
              <div class="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/95 backdrop-blur-md rounded-3xl transition-all duration-500">
                ...
                <p class="text-white/60 font-mono text-sm uppercase mb-10 tracking-wider">I'll reply within 24 hours.</p>
            ...
            <form onsubmit={onSubmit} class="space-y-8 relative z-10">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div class="space-y-2">
                  <Label for="name" class="uppercase font-mono text-[10px] tracking-widest text-white/40">Name</Label>
                ...
                <div class="space-y-2">
                  <Label for="email" class="uppercase font-mono text-[10px] tracking-widest text-white/40">Email</Label>
              ...
              <div class="space-y-2">
                <Label for="message" class="uppercase font-mono text-[10px] tracking-widest text-white/40">Message</Label>
              ...
              <div class="pt-2">
                ...
                {#if isError}
                  <div class="mt-4 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-mono uppercase tracking-widest text-center animate-in fade-in slide-in-from-top-1">
